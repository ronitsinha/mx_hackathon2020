...
if __name__ == "__main__":
	...
	bertuccis = Restaurant("Bertucci's", "bertuccis@gmail.com", "Our Address", foods)
	subway = Restaurant("Subway", "subway@gmail.com", "Some Address", {"Pizza Pockets": 2})
	add_restaurant(bertuccis)
	add_restaurant(subway)
	b = get_restaurants()
